...
// ======================
const MAINTENANCE_MODE = false; // <-- change to true to enable maintenance
...
// ======================
// Original calculator code (unchanged)
// ======================
...
calculateButton.addEventListener('click', () => {
    if (MAINTENANCE_MODE) return; // disable calculator when in maintenance
